...
public enum SituationUnc {
  BAC2("BAC+2 NON OBTENU"), CHANGE("CHANGEMENT D'ENTREPRISE"), DEM("DÉMISSION UNC EN COURS DE FORMATION "),
  DESIST("DÉSISTEMENT"), DESISTUNC("DESISTEMENT UNC (PAS DE CUA)"), ENFORMATION("EN COURS DE FORMATION"),
  FERMETURE("FERMETURE DE LA LP"), LISTECOMPL("SUR LISTE COMPLEMENTAIRE - NON APPELÉ"), TERMINE("TERMINÉ"),
  SANSOBJ("SANS OBJET");
